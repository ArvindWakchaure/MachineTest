...
let ServiceService = class ServiceService {
    constructor(httpClient) {
        ...
        this.URL = 'http://machinetestma.sankalpcs.com/UserModule/';
    }
    signIn(data) {
        this.httpOptions = {
        ...
        console.log(data);
        return this.httpClient.post(this.URL + 'Login', data, this.httpOptions)
    ...
    signUp(data) {
        ...
        console.log(data);
        return this.httpClient.post(this.URL + 'Register', data, this.httpOptions)
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.retry)(0), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(this.handleError));
    }
    getUser(data) {
