...
const routes = [
    ...
    {
        path: 'userlist',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_userlist_userlist_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./userlist/userlist.module */ 7333)).then(m => m.UserlistPageModule)
    },
    {
        path: 'login',
...
let AppComponent = class AppComponent {
    constructor(network, alertController, platform) {
...
/* harmony import */ var ng_lazyload_image__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ng-lazyload-image */ 7260);
